<template>
    ...
    <nav id="navbar-nav">
        <div class="nav__sect">
            <router-link to="/" class="white up link fs--25 fw--900"
                >Frame Fixer</router-link
            >
            <div class="nav__subsect">
                <router-link to="/pricing" class="nav__btn white up link">
                    ...
                    >
                        <path
                            d="M11 7.03255C11 1.07441 1 0.683712 1 7.03255C1 13.3814 11 12.893 11 16.507C11 20.1209 1 20.5116 1 16.507M6 0V21"
                            stroke-width="2"
                            fill="none"
                        />
                    </svg>
                ...
                <router-link
                    to="/image_upload#upscale"
                    class="nav__btn white align_center_text up link"
                >
                    Image upload
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <template v-if="!isAuthenticated">
            <div class="nav__auth-btn white">
                ...
                <router-link to="/signup" class="log-in__btn auth link"
                    >Sign up</router-link
                >
            </div>
        </template>
        <template v-else>
            <router-link to="/profile#profile" class="auth link"
                >Profile</router-link
            >
        </template>
        <router-view />

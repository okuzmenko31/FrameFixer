...
MESSAGES = {
    ...
    'complete_registration': 'Frame Fixer - complete registration.',
    'complete_email_changing': 'Frame Fixer - complete changing email',
    'complete_password_reset': 'Frame Fixer - complete password reset',

    ...
    def create_user_for_email(self, email: str, full_name: str) -> User | None:
        try:
            ...
            if self.mail_with_celery:
                ...
                send_mail(
                    subject='You successfully registered at FrameFixer.',
                    message='',
    ...
    def create_checkout_session(
        ...
        if foreign_order is not None:
            stripe_price_id = self.create_product({
                ...
                'description': foreign_order.description if foreign_order.description is not None else 'Frame Fixer',
